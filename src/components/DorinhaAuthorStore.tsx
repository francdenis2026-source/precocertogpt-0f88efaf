...
const s: Record<string, React.CSSProperties> = {
  ...
  brand:{display:"flex",alignItems:"center",gap:8,textDecoration:"none",color:"#1a0f24"},brandMark:{width:30,height:30,borderRadius:9,display:"grid",placeItems:"center",background:"linear-gradient(145deg,#3e2750,#23162d)",color:"#ffdfa1",fontWeight:950},topNav:{display:"flex",alignItems:"center",gap:25,fontSize:11,fontWeight:900,color:"#4a3b57"},topActions:{display:"flex",alignItems:"center",gap:7},iconButton:{height:36,border:"1px solid #c9bdcd",background:"white",borderRadius:9,padding:"0 11px",display:"inline-flex",alignItems:"center",gap:6,cursor:"pointer",fontWeight:800,color:"#2a1f33"},topWhats:{height:36,borderRadius:9,padding:"0 12px",display:"inline-flex",alignItems:"center",gap:6,background:"#1a0f24",color:"white",textDecoration:"none",fontWeight:900,fontSize:11},
  hero:{minHeight:440,position:"relative",backgroundSize:"cover,cover,760px 520px",backgroundPosition:"center,center,right 4% center",backgroundRepeat:"no-repeat",overflow:"hidden",color:"white",borderBottom:"1px solid rgba(255,223,161,.25)"},heroGlow:{position:"absolute",width:440,height:440,borderRadius:"50%",background:"rgba(255,223,161,.18)",filter:"blur(90px)",right:"4%",top:"-5%"},heroInner:{position:"relative",zIndex:2,maxWidth:1180,margin:"0 auto",padding:"27px 24px 25px"},heroBadges:{display:"flex",flexWrap:"wrap",gap:7},verified:{display:"inline-flex",alignItems:"center",gap:5,padding:"5px 8px",borderRadius:999,background:"rgba(137,192,255,.15)",border:"1px solid rgba(159,205,255,.35)",color:"#e6f2ff",fontSize:9.5,fontWeight:950},directBadge:{display:"inline-flex",alignItems:"center",gap:5,padding:"5px 8px",borderRadius:999,background:"rgba(255,223,161,.15)",border:"1px solid rgba(255,223,161,.4)",color:"#ffefd1",fontSize:9.5,fontWeight:950},localBadge:{padding:"7px 9px",borderRadius:999,border:"1px solid rgba(255,255,255,.2)",color:"#ffffff",fontSize:11,fontWeight:800},heroLead:{maxWidth:580,fontFamily:"Georgia,serif",fontSize:"clamp(1.05rem,1.7vw,1.4rem)",lineHeight:1.32,color:"#ffffff",margin:"0 0 8px",textShadow:"0 2px 10px rgba(0,0,0,0.3)"},heroText:{maxWidth:540,color:"#e5dee9",fontSize:13,lineHeight:1.55,fontWeight:500},heroActions:{display:"flex",flexWrap:"wrap",gap:8,marginTop:17},heroPrimary:{display:"inline-flex",alignItems:"center",gap:8,padding:"10px 14px",borderRadius:9,background:"linear-gradient(135deg,#ffdfa1,#e6c889)",color:"#1a0f24",fontWeight:950,textDecoration:"none",transition:".2s ease",boxShadow:"0 12px 28px rgba(0,0,0,.3)"},heroSecondary:{display:"inline-flex",alignItems:"center",gap:8,padding:"10px 14px",borderRadius:9,background:"rgba(255,255,255,1)",color:"#1a0f24",fontWeight:900,textDecoration:"none",transition:".2s ease",boxShadow:"0 10px 20px rgba(0,0,0,0.1)"},heroGhost:{display:"inline-flex",alignItems:"center",gap:8,padding:"12px 15px",borderRadius:10,border:"1px solid rgba(255,255,255,.3)",background:"rgba(255,255,255,.08)",color:"white",fontWeight:900,cursor:"pointer",transition:".2s ease"},heroFoot:{display:"flex",flexWrap:"wrap",gap:16,marginTop:17,color:"#ffffff",fontSize:10.5,fontWeight:600},
  section:{maxWidth:1180,margin:"0 auto",padding:"50px 24px"},sectionHead:{display:"flex",justifyContent:"space-between",alignItems:"end",gap:24,marginBottom:22},eyebrow:{display:"block",color:"#5a3f68",fontSize:9.5,fontWeight:950,letterSpacing:".16em",marginBottom:7},eyebrowGold:{display:"block",color:"#d4b266",fontSize:9.5,fontWeight:950,letterSpacing:".16em",marginBottom:7},h2:{fontFamily:"Georgia,serif",fontSize:"clamp(1.75rem,3.5vw,2.7rem)",lineHeight:1.06,letterSpacing:"-.035em",margin:"0 0 11px",fontWeight:800,color:"#1a0f24"},sectionText:{maxWidth:720,color:"#4a3b57",fontSize:14,lineHeight:1.65,fontWeight:500},catalogCount:{minWidth:112,padding:12,border:"1px solid #d4c5d6",borderRadius:12,background:"#fff",display:"grid",textAlign:"center",boxShadow:"0 10px 28px rgba(44,26,49,.08)"},
  ...
  bookType:{fontSize:8.5,fontWeight:950,color:"#5a3f68",letterSpacing:".1em"},
  available:{fontSize:8.5,fontWeight:900,color:"#1e5f3f",background:"#def2e7",padding:"4px 7px",borderRadius:999},
  bookTitle:{fontSize:17.5,fontWeight:900,color:"#1a0f24",margin:"0 0 6px",lineHeight:1.3},
  bookDescription:{fontSize:13,lineHeight:1.55,color:"#4a3b57",margin:"0 0 11px",display:"-webkit-box",WebkitLineClamp:3,WebkitBoxOrient:"vertical",overflow:"hidden",minHeight:66,fontWeight:500},
  isbn:{fontSize:9.5,color:"#716577",fontWeight:800,display:"block",marginBottom:11},
  ...
  aboutWrap:{background:"#1a0f24"},aboutMain:{padding:"8px 0"},aboutText:{color:"#ffffff",fontSize:14.5,lineHeight:1.85,maxWidth:780,fontWeight:500},aboutFacts:{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,marginTop:27},quoteCard:{background:"#ffdfa1",color:"#1a0f24",borderRadius:20,padding:"32px 28px",position:"relative",alignSelf:"stretch",display:"flex",flexDirection:"column",justifyContent:"center"},quoteMark:{fontFamily:"Georgia,serif",fontSize:70,lineHeight:.6,opacity:.3,marginTop:28},
  externalCard:{background:"white",border:"1px solid #d4c5d6",borderRadius:13,padding:15,display:"grid",gridTemplateColumns:"40px 1fr auto",gap:10,alignItems:"center",color:"#1a0f24",textDecoration:"none",transition:".2s ease",boxShadow:"0 4px 12px rgba(0,0,0,0.05)"},sourceNote:{fontSize:10.5,color:"#5a3f68",marginTop:16,fontWeight:600},
  contactWrap:{background:"linear-gradient(135deg,#2e1b38,#1a0f24)"},contactText:{color:"#ffffff",fontSize:13.5,lineHeight:1.6,maxWidth:620,fontWeight:500},contactActions:{display:"flex",gap:8,marginTop:17},contactPrimary:{display:"inline-flex",alignItems:"center",gap:7,padding:"11px 14px",borderRadius:9,background:"#ffdfa1",color:"#1a0f24",fontWeight:950,textDecoration:"none",fontSize:12.5,boxShadow:"0 8px 20px rgba(0,0,0,0.2)"},contactSecondary:{display:"inline-flex",alignItems:"center",gap:7,padding:"11px 14px",borderRadius:9,border:"1px solid rgba(255,255,255,.35)",background:"rgba(255,255,255,.05)",color:"white",fontWeight:900,cursor:"pointer",fontSize:12.5},contactCard:{background:"rgba(255,255,255,.1)",border:"1px solid rgba(255,255,255,.2)",borderRadius:15,padding:"17px 20px",color:"white",boxShadow:"0 15px 35px rgba(0,0,0,0.2)"},contactLabel:{fontSize:8.5,fontWeight:950,letterSpacing:".14em",color:"#ffefd1"},phone:{display:"block",fontFamily:"Georgia,serif",fontSize:24,margin:"5px 0 14px",color:"#ffffff"},contactLine:{display:"flex",gap:9,padding:"10px 0",borderTop:"1px solid rgba(255,255,255,.15)",fontSize:12.5,fontWeight:500},secureNote:{display:"flex",gap:7,alignItems:"center",marginTop:9,padding:9,borderRadius:9,background:"rgba(255,223,161,.15)",color:"#ffdfa1",fontSize:9.5,fontWeight:800},
